      ...
      <div className="relative z-10 flex-grow flex flex-col max-w-xl mx-auto w-full px-4 py-6 justify-between">
        ...
        {!isAnswered && (
          <button
            ...
            className="w-full py-4 bg-amber-100 hover:bg-amber-200 border-2 border-amber-350 text-amber-950 rounded-2xl font-button text-xs font-black transition-all shadow-md active:scale-98 flex items-center justify-center gap-2 cursor-pointer"
          >
